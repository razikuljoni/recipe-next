    ...
    return (
        <>
            ...
            <div className="bg-slate-900 shadow p-4 py-8" data-images={images}>
                ...
                <form onSubmit={handleCreateRecipe} className="editor mx-auto w-10/12 flex flex-col text-gray-800 border rounded-md border-gray-300 p-4 shadow-lg max-w-2xl">
